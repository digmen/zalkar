...
const Login = () => {
  ...
  const googleAuthUrl =
    "https://accounts.google.com/o/oauth2/v2/auth?redirect_uri=https://plfinal.site/google/callback/&prompt=consent&response_type=code&client_id=1055119252416-spv32uvrlfs0go1ekg227ilpuu0537s1.apps.googleusercontent.com&scope=openid%20email%20profile&access_type=offline";
